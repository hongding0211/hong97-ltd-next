    ...
    variants: {
      variant: {
        comment: cn(
          ...
          'has-aria-disabled:border-neutral-200 has-aria-disabled:bg-neutral-100 dark:has-aria-disabled:border-neutral-800 dark:has-aria-disabled:bg-neutral-800',
        ),
        default: 'h-full',
        demo: 'h-[650px]',
        select: cn(
...
const editorVariants = cva(
  cn(
    ...
    '**:data-slate-placeholder:!top-1/2 **:data-slate-placeholder:-translate-y-1/2 placeholder:text-neutral-500/80 **:data-slate-placeholder:text-neutral-500/80 **:data-slate-placeholder:opacity-100! dark:placeholder:text-neutral-400/80 dark:**:data-slate-placeholder:text-neutral-400/80',
    '[&_strong]:font-bold',
  ),
  {
    defaultVariants: {
