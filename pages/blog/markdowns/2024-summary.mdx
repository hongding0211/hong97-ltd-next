...
import { TLDR, Imgs0, Imgs1, Imgs2, Imgs3, Imgs4, Imgs5, Imgs6, Imgs7, Imgs8, Imgs9, End } from '../components/2024-summary'
...
九月，在经历了一个月的恐怖面试（日均 2.5 场）之后，拿到了字节、阿里、百度、Shine 等 5 个 Offer。
